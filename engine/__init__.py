...
transform_manager.set_tran_path(_abs_path("../cil/tran.native"))
transform_manager.set_output_path(_abs_path("../tmp/"))

rl_mgr.setExePath(_abs_path("../ext_quantifier/reduce/reduce"))
rl_mgr.setScriptPath(_abs_path("../tmp/rl_script"))
rl_mgr.setOutputPath(_abs_path("../tmp/rl_summary"))
...
options = {
  ...
  "output_dir":_abs_path("../tmp/proof")}
